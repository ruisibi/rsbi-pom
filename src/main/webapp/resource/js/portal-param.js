...
function newparam(tp, paramType, pid){
	...
	$('#pdailog').dialog({
		...
		buttons:[{
			...
			iconCls:"icon-ok",
			handler:function(){
				var paramid = "p_" + Math.round(Math.random() * 100000);
