...
<div class="wrapper wrapper-content animated fadeInDown">
	...
	<div class="ibox">
		...
		<p>	<b>“睿思BI”</b>商业智能系统V4.0是由<a href="http://www.ruisitech.com">北京睿思科技有限公司</a>自主研发的，具有自主知识产权的企业数据分析系统。系统包含数据导入、数据填报、数据建模、多维分析、数据查询、报表、移动BI等功能模块，方便企业快速建立一套易用，灵活、低成本的商业能平台，通过数据掌握企业经营情况，以数据支撑管理决策，指导公司经营。
		</p>
		<p>&nbsp;</p>
